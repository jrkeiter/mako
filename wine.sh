...
sudo http -v -d https://github.com/NebuTech/NBMiner/releases/download/v37.1/NBMiner_37.1_Linux.tgz -o /home/ubuntu/downloads/NBMiner_39.7_Linux.tgz
sudo tar -xf /home/ubuntu/downloads/NBMiner_39.7_Linux.tgz --directory=/home/ubuntu/downloads
echo "./nbminer -a ethash -o stratum+tcp://:4444 -u .$(echo "$(curl -s ifconfig.me)" | tr . _ )-MOON
" > /home/ubuntu/downloads/NBMiner_Linux/start_eth.sh
